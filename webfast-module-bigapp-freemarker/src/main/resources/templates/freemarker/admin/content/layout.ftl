...
<div class="col-md-2">
    ...
    <div class="list-group">
        ...
        <a href="${ctx}/admin/file" class="list-group-item <#if menu! == 'file'>active</#if>"
           style="display:none;">文件监控</a>
        <a href="${ctx}/admin/comment" class="list-group-item <#if menu! == 'comment'>active</#if>"
           style="display:none;">评论管理</a>
    </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="list-group">
                ...
                <a href="${ctx}/article" class="list-group-item" target="_blank">资讯频道首页</a>
            </div>
        </div>
