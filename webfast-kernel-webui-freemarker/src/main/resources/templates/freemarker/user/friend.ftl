...
<div class="row">
	<div class="col-md-12">
		<ul class="nav nav-pills nav-mini userpage-sec-nav">
			<li <#if friendNav == 'following'>class="active"</#if>><a href="${ctx}/user/${user.id}/following">关注</a>
			</li>
	...
	<div class="row">
		<#if friends??>
			<#list friends?values as friend>
				<div class="col-md-4">
					<div class="friendcard clearfix">
						<a href="${ctx}/user/${friend.id}"><img src="${default_path('avatar', friend.mediumAvatar, '')}"
																class="avatar"></a>
						<div class="infos">
