...
<form id="role-permissions-form" class="form-horizontal" method="post" action="${ctx}/admin/role/${roleId}/permissions" data-currentuser="${appUser.id}" data-edituser="${roleId}">
  <div class="checkboxs">
  	<#list permissions as perm>
    <label>
    	<input type="checkbox" name="permissions[]" value="${perm.permissionKey}" >${perm.label}
    </label>
