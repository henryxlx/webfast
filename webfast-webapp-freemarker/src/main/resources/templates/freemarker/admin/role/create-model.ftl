...
<#macro blockBody>
        <form class="form-horizontal" id="role-form" action="<#if (role.id)!0 gt 0>${ctx}/admin/role/${role.id}/update<#else>${ctx}/admin/role/create</#if>" method="post">
            <div class="form-group">
                <label class="col-md-3 control-label" for="role-name-field">角色名称</label>
                <div class="col-md-6 controls">
                    <input class="form-control" id="role-name-field" type="text" name="roleName" value="${(role.roleName)!}" data-url="${ctx}/admin/role/checkname?exclude=${(role.roleName)!}">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-3 control-label" for="role-label-field">角色描述</label>
                <div class="col-md-6 controls">
                    <input class="form-control" id="role-label-field" type="text" name="label" value="${(role.label)!}">
                </div>
            </div>
