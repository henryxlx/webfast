 ...
 * @author xulixin
 */
public class IpRealDataSeeker {

    private static final Logger log = LoggerFactory.getLogger(IpRealDataSeeker.class);

    public static final IpRealDataSeeker getInstance() {
        try {
            return new IpRealDataSeeker();
        } catch (Exception e) {
            log.warn("无法打开qqwry.dat文件.");
            return null;
        }
    }
    ...
    private IpRealDataSeeker() throws Exception {
        String file = IpRealDataSeeker.class.getClassLoader().getResource("qqwry.dat").getPath();
    ...
    public String getAddress(String ip) {
        ...
        return cache == null ? "查询不到此IP" : cache.getCountry() + " " + cache.getArea();
    }
    ...
    public String getCountry(String ip) {
        IPLocation cache = getIpLocationNotNull(ip);
    ...
    public IPLocation getIpLocationNotNull(String ip) {
